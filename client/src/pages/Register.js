      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <Link to="/" className="block text-center mb-6">
            <span className="text-primary font-bold text-2xl">CampusConnect</span>
          </Link>
          <h2 className="mt-6 text-3xl font-extrabold text-gray-900 dark:text-gray-100">Create your CampusConnect account</h2>
